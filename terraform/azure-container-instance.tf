...
#  location            = azurerm_resource_group.docker_agentpool_rg[var.aci_subnet.rg_key].location
#  resource_group_name = azurerm_resource_group.docker_agentpool_rg[var.aci_subnet.rg_key].name
...
#    username = azurerm_container_registry.george_acr.admin_username
#    password = azurerm_container_registry.george_acr.admin_password
#    server   = azurerm_container_registry.george_acr.login_server
#  }
#
#  container {
